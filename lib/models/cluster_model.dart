...
class ClusterModel {
    ...
    factory ClusterModel.fromRawJson(String str) => ClusterModel.fromJson(json.decode(str));
...
class Data {
    ...
    factory Data.fromJson(Map<String, dynamic> json) => Data(
        ...
        activeAgents: List<ActiveAgent>.from(json["active_agents"].map((x) => ActiveAgent.fromJson(x))),
        inactiveAgents: List<ActiveAgent>.from(json["inactive_agents"].map((x) => ActiveAgent.fromJson(x))),
    );
    ...
    Map<String, dynamic> toJson() => {
        ...
        "active_agents": List<dynamic>.from(activeAgents!.map((x) => x.toJson())),
        "inactive_agents": List<dynamic>.from(inactiveAgents!.map((x) => x.toJson())),
    };
}
...
class ActiveAgent {
    ...
    factory ActiveAgent.fromRawJson(String str) => ActiveAgent.fromJson(json.decode(str));
...
class Agent {
    ...
    factory Agent.fromJson(Map<String, dynamic> json) => Agent(
        ...
        recentLoan: json["recent_loan"] == null ? null : RecentLoan.fromJson(json["recent_loan"]),
...
class RecentLoan {
    ...
    factory RecentLoan.fromRawJson(String str) => RecentLoan.fromJson(json.decode(str));
...
class AgentLoan {
    ...
    factory AgentLoan.fromRawJson(String str) => AgentLoan.fromJson(json.decode(str));
